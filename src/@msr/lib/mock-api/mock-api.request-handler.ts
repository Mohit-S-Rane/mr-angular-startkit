...
import { MsrMockApiReplyCallback } from '@msr/lib/mock-api/mock-api.types';

export class MsrMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: MsrMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: MsrMockApiReplyCallback): void
    {
        // Store the reply
