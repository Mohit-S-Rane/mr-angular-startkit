...
export class MailboxSidebarComponent implements OnInit, OnDestroy
{
    ...
    private _filtersMenuData: MsrNavigationItem[] = [];
    private _foldersMenuData: MsrNavigationItem[] = [];
    private _labelsMenuData: MsrNavigationItem[] = [];
    private _otherMenuData: MsrNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void
    {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: MsrNavigationItem = {
                id   : folder.id,
                title: folder.title,
                type : 'basic',
                icon : folder.icon,
    ...
    private _updateNavigationBadge(folders: MailFolder[]): void
    {
        ...
        const mainNavigationComponent = this._msrNavigationService.getComponent<MsrVerticalNavigationComponent>('mainNavigation');

        // If the main navigation component exists...
        if ( mainNavigationComponent )
        {
            const mainNavigation = mainNavigationComponent.navigation;
            const menuItem = this._msrNavigationService.getItem('apps.mailbox', mainNavigation);
