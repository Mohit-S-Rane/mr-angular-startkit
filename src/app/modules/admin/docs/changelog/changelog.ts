            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(@msr/navigation) Added "fragment" and "queryParams" support along with "preserveFragment" and "queryParamsHandling" on navigation items',
                        '(@msr/overrides/quill) Added tooltip styles for better compatibility',
                        '(@msr/services/platform) Added platform checker service',
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(MsrDrawer) Updated the overlay and animation handling code for better stability',
                        '(@msr/overrides/quill) Better scrolling for Quill editor',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@msr/navigation) Collapse animation doesn"t work smoothly because of the parent"s margin',
                        '(@msr/service/confirmation) Cleaned-up the dialog component',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@msr/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@msr/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@msr/masonry) Removed the unnecessary scss file'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(MsrLoadingBar) Added the MsrLoadingBar component, its helper service and its interceptor'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(MsrDateRange) BREAKING: Removed the MsrDateRange component, alternative: https://github.com/fetrarij/ngx-daterangepicker-material'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@msr/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        '(@msr/navigation) Don\'t need to use interpolation on scss variables anymore since Tailwind doesn\'t cause any problems with them anymore'
                    ]
                }
            ]
        },
        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@msr/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@msr/theming) Better structuring on the themes.scss file',
                        '(@msr) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Msr is a lot smaller compared to the one with the old design'
                    ]
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@msr/overrides) Quill editor is not styled correctly by default',
                        '(@msr/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(msr/confirmation) Confirmation dialog colors are not optimized for the Dark mode'
                    ]
                }
            ]
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(msr/confirmation) A service to quickly configure and show confirmation dialogs'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using MsrConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using MsrConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using MsrConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using MsrConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for MsrConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Msr Components and Other Components into UI for better visibility and better categorization'
                    ]
                },
                {
                    type: 'Fixed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(msr/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(msr/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "msr-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(msr/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(msr/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(msr/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(msr/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(msr/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(msr/autogrow) BREAKING: Removed "msrAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(MsrNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303'
                    ]
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(MsrNavigation) Added a generic return type for "getComponent" method on MsrNavigationService',
                        '(MsrNavigation) Use the generic return type for "getComponent"',
                        '(msr) Fixed barrel exports',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(msr/masonry) Added a component for creating fast Masonry-like layouts'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(msr/fullscreen) Added fullscreen toggle component'
                    ]
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        'This is the new major version of the Msr and it\'s completely different from previous versions with no upgrade path',
