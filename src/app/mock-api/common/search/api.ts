...
import { MsrNavigationItem, MsrNavigationService } from '@msr/components/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._msrNavigationService.getFlatNavigation(this._defaultNavigation);
