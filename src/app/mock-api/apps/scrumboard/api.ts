...
import { MsrMockApiService, MsrMockApiUtils } from '@msr/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._msrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = MsrMockApiUtils.guid();
        ...
        this._msrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = MsrMockApiUtils.guid();
        ...
        this._msrMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = MsrMockApiUtils.guid();
